...
The underlying database is assembled from public datasets (see `dbase.pptx` for the full build pipeline):
...
├── db_config.py            # Database credentials and connection URI
├── requirements.txt        # Python dependencies
├── dbase.pptx              # Documentation of the data build pipeline
├── docs/
...
Edit `db_config.py` to match your MySQL setup (the values committed to the repo are placeholders):
